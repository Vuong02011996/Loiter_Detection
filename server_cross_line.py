...
api = Api(api_blueprint, title="Cross Line Detection Project", version="1.0.0", description="Swagger API Homepage")
...
if __name__ == "__main__":
    ...
    app.run(host=os.getenv("SERVER_HOST"), port=os.getenv("SERVER_PORT_CROSS_LINE"), threaded=True, debug=True, use_reloader=False)
