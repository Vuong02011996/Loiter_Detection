...
import ast
from app.services.intrusion_detection.intrusion_detection_helper import convert_coordinates
...
from core.main.export_data_v3 import export_data_intrusion_detection
...
def run_intrusion(item_cam, end_time_s, info_cam_running, test_video=False, cv2_show=True, window="test"):
