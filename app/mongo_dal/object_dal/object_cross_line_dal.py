...
from app.mongo_models.object_model.object_cross_line import ObjectCrossLine


class ObjectCrossLineDAL(BaseDAL):
    def __init__(self):
        super().__init__(ObjectCrossLine)
    ...
    def find_all_by_process_name(self, process_name):
        pipeline = [
            {"$match": {"process_name": process_name}},
            # {"$project": {"_id": 1}}
        ]
